...
public class MetaTileEntityLoader {
    ...
    public static void init(Consumer<FinishedRecipe> provider) {
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, "steam_macerator_bronze",
                ...
                'X', new UnificationEntry(TagPrefix.pipeSmall, GTMaterials.Bronze), 'P', CustomTags.TAG_PISTONS,
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, "steam_hammer_bronze",
                ...
                new UnificationEntry(TagPrefix.pipeSmall, GTMaterials.Bronze), 'P', CustomTags.TAG_PISTONS, 'A',
                Blocks.ANVIL);
